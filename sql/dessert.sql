...
CREATE TABLE `dessert` (
  ...
  `sale_volume` int(11) DEFAULT '0' COMMENT '总销量',
  PRIMARY KEY (`id`)
...
INSERT INTO `dessert` VALUES (1,'雪域牛乳芝士蛋糕','到过阿尔卑斯山脉勃朗峰才发现，白，其实就这么纯粹。雪花忽聚忽散，轻盈降落在地上，化为一片白。那个清晨，我踏上厚厚的初雪，出乎意料，是松软的触感。',188,NULL,0,'2016-05-02',0),(2,'提拉米苏乐脆蛋糕','带我走。是Tiramisu意大利文的意思。意大利甜品师用它带走了法国女孩的心，还在巴黎开了一间小店，分享这幸福的味道。他，令人芳心暗许。',218,NULL,0,'2016-06-13',0),(3,'大尉蛋糕','轻柔的抹茶芝士慕斯与浓郁抹茶芝士的双倍浓醇，汇聚成对宋欧巴最浓烈的情感；巧克力戚风的甜蜜有着恋爱般的幸福滋味，迷彩蛋糕胚更是完美还原宋欧巴的制服诱惑，让蛋糕在品味的同时更是还原追剧时的迷恋甜蜜感。',128,NULL,0,'2016-06-24',0),(4,'玫瑰雪域芝士蛋糕','一片玫瑰的海洋，映衬着少男少女那纯净的心境。这么多朵玫瑰花，总像有数不清的芬芳思念，诉不尽的感恩眷恋，所有声音都在轻声呢喃着誓约长久。',188,NULL,0,'2016-06-08',3),(5,'双莓提拉米苏乐脆蛋糕','包裹浪漫的红色巧克力喷砂，编织每一口滋味的梦幻；草莓与桑莓的酸甜果味碰撞，擦出清新甜蜜的纯真乐趣，交织酥香与芝士奶油的绵密浓郁，口口留香，唇齿缠绵。浪漫的爱情故事，在味蕾中浓情上演。',188,NULL,0,'2016-06-11',0),(6,'雪域大理石芝士蛋糕','简约的几何、原始的色调，却是不平凡的杰作。德国包豪斯设计往往是简单而有力。如琴键黑白之间合拍的跃动，谱出一段段震撼的乐曲。空气凝止，余韵仍萦绕不去。',188,NULL,0,'2016-06-14',0),(7,'海盐乳酪芝士蛋糕','充满回忆的味道，总令人难以忘怀。那是西西里岛的风味，充满渔夫自然不造作的热情， 与素未谋面的我，分享渔获，分享喜悦。',188,NULL,0,'2016-06-22',0),(8,'派对物语','当阿尔卑斯峰顶的纯雪遇上鲜莓，无限的思念开始蔓延，酸甜如同初次的相遇，清新怡人，浓郁香醇则如同相熟后的情谊，一切都是幸福的味道。',145,NULL,0,'2016-06-22',0),(9,'芒果芒果蛋糕','到东南亚，是为了追逐所有金黄色。阳光，一如以往的金黄。大海，折射着一片金黄色的清澄。沙滩，是金黄色的幼滑。空气，泛着金黄色自有的香甜。（鲜果因时令季节变化，会做适当调整）',188,NULL,0,'2016-06-22',7),(10,'繁星之吻','这世界色彩太多快乐也变得无所适从，而纯味奶油与酸甜蓝莓的混搭却能治愈快乐缺乏症。点缀在蓝紫色奶油上的颗颗果肉，犹如星空成为了每个人心中最神秘的向往。',188,NULL,0,'2016-06-22',0),(11,'五重巧克力幻想蛋糕','一口尝，脆、香、浓、软、滑，五种层次，如置身在一个巧克力的漩涡，愈往上游，愈沉迷不舍。经典的巧克力，经典的时尚图案，已经成为永恒的象征。',218,NULL,0,'2016-06-22',0),(12,'公主蛋糕','童年是一段像棉花糖一样柔软的记忆，人总叹息时日匆匆，带走了纯真的心境，却忘了童真带来的勇气，带领孩子，寻找内心的乐园。',188,NULL,0,'2016-06-22',10),(13,'草莓拿破仑蛋糕','盒子上娇艳欲滴的红宝石，令人无法移开目光。像潘多拉的盒子，吸引好奇的味蕾。清脆的声音，没有惊醒少女的梦。（鲜果因时令季节变化，会做适当调整）',188,NULL,0,'2016-06-22',0),(14,'芒果千层拿破仑蛋糕','太阳花，从法国的南部开到花都。 欢迎盛夏。巴黎小街填满了阳光，像拿破仑蛋糕薄脆之间的浓滑奶油。这……是我爱上仲夏的理由。（鲜果因时令季节变化，会做适当调整）',188,NULL,0,'2016-06-22',0),(15,'环游世界·春夏季蛋糕','惊喜，是任性送给我的礼物。随心、随性、随感觉到处游历，每次都有新发现。惊喜，不用刻意安排。又或者，上天早已安排， 怎样，都好，就随意一点，任性一次吧。',218,NULL,0,'2016-06-22',0),(16,'拿铁咖啡','牛奶的温润调味,让原本甘苦的咖啡变得柔滑香甜，甘美浓郁,就连不习惯喝咖啡的人,也难敌拿铁芳美的滋味。',32,NULL,3,'2016-06-24',0),(17,'卡布奇诺','特浓咖啡的浓郁口味，配以润滑的奶泡，颇有一些汲精敛露的意味；撒上了肉桂 粉的起沫牛奶，混以自下而上的意大利咖啡的香气，新一代咖啡族为此而心动不已。',32,NULL,3,'2016-06-24',2);
...
-- Dump completed on 2016-06-24 15:38:20
