...
<body>
	...
	<div class="filters">
		...
		<div class="right search">
			...
			<div class="btn search-btn right" id="js-search"><i class="fa fa-search"></i></div>
		</div>
	</div>
	...
	<ul class="dessert-stack-nav">
		<%	if(request.getSession().getAttribute("isUser") != null){
				out.print("<li class='stack-nav-item nav-to-cart'><a href='" + request.getContextPath()
		...
		<li class="stack-nav-item js-type-filter" value="5"><i class="nav-icon juice-icon"></i><span>果汁</span></li>
		<li class="stack-nav-item nav-to-top js-to-top"><i class="fa fa-angle-up"></i></li>
	</ul>
	<!-- 
	<nav>
		<ul class="pagination">
